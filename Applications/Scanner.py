...
def message_window():
    layout = [
        [gui.Text("Scanning will start 5 seconds after button is clicked!", text_color='orange', background_color='white')],
        [gui.Button("CLOSE", border_width=0, image_data=_C_BUTTON_, enable_events=True)]
    ]
    window = gui.Window("Alert", layout=layout, background_color='white', button_color=('orange', 'white'), icon=_C_LOGO_)
...
def dummy():
    layout = [
        [gui.Text("Click 'Close' when ready!", text_color='orange', background_color='white')],
        [gui.Button("CLOSE", image_data=_C_BUTTON_, border_width=0, enable_events=True)]
    ]
    win = gui.Window("", layout=layout, background_color='white', button_color=('orange', 'white'), border_depth=0, keep_on_top=True, icon=_C_LOGO_)
...
def test_window():
    layout = [
        ...
        [gui.Multiline("", size=(60, 5))],
        [gui.Button("SCAN", image_data=_C_BUTTON_, border_width=0), gui.Text("Popup Between Scans", text_color='orange', background_color='white'), gui.Spin((False, True)), gui.Text("Delay (seconds)", background_color='white', text_color='orange'), gui.Spin([i for i in range(10)])]
    ]

    window = gui.Window(f"Scanner {version}", layout=layout, background_color='white', button_color=('orange', 'white'), icon=_C_LOGO_)
    while True:
